...
<head>
    ...
    <title>{{ config('app.name', 'Laravel 9 Admin') }}</title>
            ...
            <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
                ...
                <header class="relative bg-white dark:bg-darker">
                    <div class="flex items-center justify-between p-2 border-b dark:border-primary-darker">
                        ...
                        <a href="index.html"
                            ...
                            {{ config('app.name', 'Laravel 9 Admin') }}
                        </a>
                            ...
                            <div class="relative" x-data="{ open: false }">
                                <button @click="open = !open; $nextTick(() => { if(open){ $refs.userMenu.focus() } })"
                                    ...
                                    <img class="w-10 h-10 rounded-full"
                                        src="{{ asset('assets/admin/images/avatar.jpg') }}" alt="Jamshed Farzand" />
                                </button>
                ...
                <main>
                    ...
                    <div
                        ...
                        <a href="https://github.com/jamshedfarzandpk" target="_blank"
                ...
                <footer
                    ...
                    <div>jamshed farzand &copy; 2023</div>
                    <div>
                        Made by
                        <a href="https://github.com/jamshedfarzandpk" target="_blank"
                            class="text-blue-500 hover:underline">Jamshed Farzand</a>
                    </div>
                </footer>
            </div>
